...
// Example function for handling automation logic
function applyAutomation() {
    const startTime = document.getElementById('scheduleStart').value;
    const endTime = document.getElementById('scheduleEnd').value;
    alert('Automation applied from ' + startTime + ' to ' + endTime);
    // Implement actual automation logic here
}
...
var lightIp = '192.168.84.43'; // Replace with your ESP32's IP address
...
function setEffectSerial(effectId) {
    // const lightIp = '192.168.84.43'; // Replace with your ESP32's IP address

    const xhr = new XMLHttpRequest();
    xhr.open('POST', `/json/state`, true);
    xhr.setRequestHeader('Content-Type', 'application/json;charset=UTF-8');
    xhr.send(JSON.stringify({ seg: { fx: effectId } }));
